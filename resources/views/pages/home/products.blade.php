<section class="py-16 md:py-32 bg-gradient-to-b from-white via-gray-50/30 to-white relative overflow-hidden">
    ...
    flex items-center justify-center gap-4">
                        ...
                        <div class="w-14 h-14 md:w-16 md:h-16 bg-white/95 backdrop-blur-md rounded-2xl flex items-center justify-center text-gray-900 transform scale-50 group-hover:scale-100 transition-all duration-500 shadow-2xl hover:shadow-black/50 hover:bg-gray-100 cursor-pointer">
