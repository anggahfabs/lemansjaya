...
<div
    x-data="{
        openCreate: false,
        openEdit: false,
        baseUrl: '{{ route('admin.contact_settings.index') }}',
        editData: {
            id: null,
            title: '',
            description: '',
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm text-slate-600">{{ Str::limit($item->description, 60) }}</span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            @if($item->is_active)
    ...
    >
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden" @click.stop>
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-white">Add Contact Info</h2>
            </div>

            <form
                action="{{ route('admin.contact_settings.store') }}"
                method="POST"
            ...
            >
                ...
                <div>
                    ...
                    <input 
                        name="title" 
                        placeholder="e.g. Our Location, Phone Number"
                ...
                <div>
                    ...
                    <textarea 
                        name="description"
                        placeholder="e.g. 123 Main St, City or +62 812 3456 7890"
                        rows="3" 
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    ></textarea>
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Logo/Icon</label>
                    <input 
                        type="file" 
                        name="logo" 
                        accept="image/*"
    ...
    >
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden" @click.stop>
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-white">Edit Contact Info</h2>
            </div>
            ...
            >
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Change Logo/Icon</label>
