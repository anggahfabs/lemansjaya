...
<div class="pt-32 md:pt-40 pb-24 bg-gray-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16 md:mb-24" data-aos="fade-down">
            <h2 class="text-yellow-400 font-bold uppercase mb-4 text-[10px] md:text-sm tracking-widest">World Class Care</h2>
            <h1 class="text-3xl md:text-6xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight px-4">Our Professional Services</h1>
            <div class="w-24 md:w-48 h-1.5 md:h-2.5 bg-yellow-400 mx-auto rounded-full mb-6 md:mb-8"></div>
        ...
        @if($services->count())
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                @foreach($services as $index => $service)
                    <div 
                        class="group bg-white rounded-3xl md:rounded-[4rem] overflow-hidden shadow-lg md:shadow-xl shadow-gray-200 border border-gray-100 hover:shadow-2xl hover:shadow-yellow-200 transition-all duration-700"
                        data-aos="fade-up" 
                    ...
                    >
                        ...
                        <div class="relative h-64 md:h-80 overflow-hidden">
                            ...
                            @if(isset($service->price))
                                <div class="absolute top-6 md:top-8 right-6 md:right-8 bg-white/95 backdrop-blur-md px-4 md:px-5 py-1.5 md:py-2 rounded-full text-[10px] md:text-xs font-bold text-yellow-400 shadow-lg border border-white/20">
                        ...
                        <div class="p-8 md:p-12">
                            <h3 class="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6 group-hover:text-yellow-400 transition-colors leading-tight">
                                {{ $service->name }}
                            </h3>
                            ...
                            <a href="{{ route('appointments.index') }}" class="inline-flex items-center gap-3 md:gap-4 text-gray-900 font-bold hover:gap-5 md:hover:gap-6 transition-all text-xs md:text-sm group/btn">
                                ...
                                <div class="w-8 h-8 md:w-12 md:h-12 rounded-full border border-gray-100 flex items-center justify-center group-hover/btn:bg-yellow-400 group-hover/btn:text-white group-hover/btn:border-yellow-400 transition-all duration-300">
        ...
        {{-- CTA Section --}}
        <div class="mt-24 md:mt-32 bg-yellow-400 rounded-3xl md:rounded-[4rem] p-8 md:p-20 text-center relative overflow-hidden group" data-aos="zoom-in">
            ...
            <div class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 px-4">
                    <a href="{{ route('appointments.index') }}" class="bg-white text-yellow-400 px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-bold hover:scale-105 transition-transform active:scale-95 shadow-xl text-sm md:text-base">
                        Book Appointment
                    </a>
                    <a href="{{ route('contact.index') }}" class="bg-yellow-700/50 backdrop-blur-md text-white border-2 border-white/20 px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-bold hover:bg-yellow-700 transition-all text-sm md:text-base">
                        Contact Support
                    </a>
                </div>
            </div>
