...
<div
    x-data="{
        openCreate: false,
        openEdit: false,
        baseUrl: '{{ route('admin.galleries.index') }}',
        editData: {
            id: null,
            caption: '',
            is_active: true,
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-200">
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Caption</th>
                    ...
                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                        <td class="px-6 py-4 text-center">
                            <img
                                ...
                                class="h-16 w-16 object-cover rounded-lg mx-auto border border-slate-200 shadow-sm"
                                alt="{{ $item->caption ?? 'Gallery image' }}"
                            >
                        </td>
                        <td class="px-6 py-4">
                            @if($item->caption)
                                <span class="text-sm text-slate-700">{{ $item->caption }}</span>
                            @else
                                <span class="text-sm text-slate-400 italic">No caption</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-center">
                            @if($item->is_active)
    ...
    >
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden" @click.stop>
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-white">Add Gallery Image</h2>
            </div>
    ...
    >
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden" @click.stop>
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-white">Edit Gallery Image</h2>
            </div>
