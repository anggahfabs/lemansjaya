    ...
    <div class="max-w-[1800px] mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8" data-aos="fade-up">
            <div class="max-w-3xl">
                ...
                <h2 class="text-yellow-500 font-bold uppercase mb-4 text-[10px] md:text-sm bg-yellow-50 px-4 py-2 rounded-full inline-block shadow-lg shadow-yellow-500/20">Visual Journey</h2>
                <!-- Added gradient text to title -->
                <h1 class="text-3xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent leading-tight px-2 md:px-0 text-center md:text-left">Gallery of <span class="bg-gradient-to-r from-yellow-400 to-yellow-500 bg-clip-text text-transparent">Happiness</span></h1>
            </div>
